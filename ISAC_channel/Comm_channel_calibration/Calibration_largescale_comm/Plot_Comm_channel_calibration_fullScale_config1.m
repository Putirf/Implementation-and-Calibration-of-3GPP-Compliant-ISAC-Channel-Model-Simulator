function Plot_Comm_channel_calibration_fullScale_config1(selected_scenario)
...
benchmark_file = fullfile(script_dir, 'Phase2Config1Calibration_v35_CMCC.xlsx');
...
metric_configs = {
    ...
    localMetricConfig('DS', 'DS (ns)', 'DS', 3)
    localMetricConfig('ASD', 'ASD (degree)', 'ASD', 4)
    localMetricConfig('ZSD', 'ZSD (degree)', 'ZSD', 5)
    localMetricConfig('ASA', 'ASA (degree)', 'ASA', 6)
    localMetricConfig('ZSA', 'ZSA (degree)', 'ZSA', 7)
};
...
raw_matrix = readmatrix(benchmark_file, 'Sheet', sheet_name, 'Range', 'B29:HI129');
