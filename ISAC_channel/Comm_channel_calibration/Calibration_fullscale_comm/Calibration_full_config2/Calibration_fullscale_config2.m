...
% Entry script: choose a scenario, run Config 2 calibration, then plot results.
...
Calibration_fullscale_config2_run(selected_scenario);
Plot_Comm_channel_calibration_fullScale_config2(selected_scenario);
